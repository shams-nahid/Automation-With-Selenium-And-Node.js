...
function MainHTML(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      useInlineAssets ? React.createElement('style', { dangerouslySetInnerHTML: { __html: inlineStyles } }) : React.createElement('link', { rel: 'stylesheet', href: stylesUrl })
    ),
    React.createElement(
      'body',
      { 'data-raw': data, 'data-config': JSON.stringify(options) },
      React.createElement('div', { id: 'report' }),
      useInlineAssets ? React.createElement('script', { type: 'text/javascript', dangerouslySetInnerHTML: { __html: inlineScripts } }) : React.createElement('script', { src: scriptsUrl })
    )
  );
}
